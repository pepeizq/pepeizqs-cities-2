...
public class Escenario : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        {
            listadoCasillasInicial = new List<Vector3> {new Vector3(50, 4, 7),
new Vector3(54, 3.5f, 7),
new Vector3(50, 3.5f, 11),
new Vector3(53, 3.5f, 10),
new Vector3(46, 3.5f, 7),
new Vector3(53, 3.5f, 4),
new Vector3(55, 3, 2),
new Vector3(44, 3, 7),
new Vector3(55, 3, 2),
new Vector3(49, 3, 13),
new Vector3(50, 3, 13),
new Vector3(44, 3, 5),
new Vector3(58, 2.5f, 7),
new Vector3(43, 2.5f, 14),
new Vector3(42, 2.5f, 4),
new Vector3(58, 2.5f, 5),
new Vector3(42, 2.5f, 8),
new Vector3(42, 2.5f, 7),
new Vector3(43, 2.5f, 14),
new Vector3(45, 2, 16),
new Vector3(45, 2, 17),
new Vector3(45, 2, 18),
...
new Vector3(41, 2, 7),
new Vector3(41, 2, 8),
new Vector3(48, 1.5f, 18),
new Vector3(48, 1.5f, 19),
new Vector3(48, 1.5f, 20),
new Vector3(49, 1.5f, 18),
new Vector3(49, 1.5f, 19),
new Vector3(49, 1.5f, 20),
new Vector3(50, 1.5f, 18),
new Vector3(50, 1.5f, 19),
new Vector3(50, 1.5f, 20),
new Vector3(61, 1.5f, 10),
new Vector3(61, 1.5f, 11),
new Vector3(61, 1.5f, 12),
new Vector3(62, 1.5f, 10),
new Vector3(62, 1.5f, 11),
new Vector3(62, 1.5f, 12),
new Vector3(63, 1.5f, 10),
new Vector3(63, 1.5f, 11),
new Vector3(63, 1.5f, 12),
new Vector3(60, 1.5f, 17),
new Vector3(60, 1.5f, 18),
new Vector3(60, 1.5f, 19),
new Vector3(61, 1.5f, 17),
new Vector3(61, 1.5f, 18),
new Vector3(61, 1.5f, 19),
new Vector3(62, 1.5f, 17),
new Vector3(62, 1.5f, 18),
new Vector3(62, 1.5f, 19),
new Vector3(61, 1.5f, 3),
new Vector3(61, 1.5f, 4),
new Vector3(61, 1.5f, 5),
new Vector3(62, 1.5f, 3),
new Vector3(62, 1.5f, 4),
new Vector3(62, 1.5f, 5),
new Vector3(63, 1.5f, 3),
new Vector3(63, 1.5f, 4),
new Vector3(63, 1.5f, 5),
new Vector3(34, 1, 2),
new Vector3(34, 1, 3),
new Vector3(35, 1, 2),
new Vector3(35, 1, 3),
...
new Vector3(38, 1, 3),
new Vector3(43, 7, 43),
new Vector3(46, 6.5f, 40),
new Vector3(46, 6.5f, 40),
new Vector3(47, 6.5f, 42),
new Vector3(42, 6.5f, 39),
new Vector3(43, 6, 49),
new Vector3(37, 6, 43),
new Vector3(43, 6, 37),
new Vector3(49, 6, 43),
new Vector3(48, 6, 48),
new Vector3(35, 5.5f, 41),
new Vector3(36, 5.5f, 50),
new Vector3(43, 5.5f, 35),
new Vector3(51, 5.5f, 41),
new Vector3(36, 5.5f, 50),
new Vector3(46, 5, 53),
new Vector3(31, 4.5f, 47),
new Vector3(48, 4, 57),
new Vector3(41, 4, 57),
new Vector3(57, 4, 44),
new Vector3(45, 4, 29),
new Vector3(37, 3.5f, 59),
new Vector3(59, 3.5f, 41),
new Vector3(59, 3.5f, 42),
new Vector3(28, 3.5f, 58),
new Vector3(59, 3.5f, 40),
new Vector3(26, 3, 60),
new Vector3(60, 3, 26),
new Vector3(40, 3, 25),
new Vector3(62, 2.5f, 24),
new Vector3(23, 2.5f, 35),
new Vector3(45, 2.5f, 23),
new Vector3(51, 2.5f, 23),
new Vector3(34, 2.5f, 63),
new Vector3(62, 2.5f, 62),
new Vector3(63, 2, 21),
new Vector3(63, 2, 22),
new Vector3(63, 2, 23),
new Vector3(64, 2, 21),
...
new Vector3(50, 1.5f, 19),
new Vector3(50, 1.5f, 20),
new Vector3(51, 1.5f, 18),
new Vector3(51, 1.5f, 19),
new Vector3(51, 1.5f, 20),
new Vector3(52, 1.5f, 18),
new Vector3(52, 1.5f, 19),
new Vector3(52, 1.5f, 20),
new Vector3(18, 1.5f, 44),
new Vector3(18, 1.5f, 45),
new Vector3(18, 1.5f, 46),
new Vector3(19, 1.5f, 44),
new Vector3(19, 1.5f, 45),
new Vector3(19, 1.5f, 46),
new Vector3(20, 1.5f, 44),
new Vector3(20, 1.5f, 45),
new Vector3(20, 1.5f, 46),
new Vector3(18, 1.5f, 48),
new Vector3(18, 1.5f, 49),
new Vector3(18, 1.5f, 50),
new Vector3(19, 1.5f, 48),
new Vector3(19, 1.5f, 49),
new Vector3(19, 1.5f, 50),
new Vector3(20, 1.5f, 48),
new Vector3(20, 1.5f, 49),
new Vector3(20, 1.5f, 50),
new Vector3(66, 1.5f, 32),
new Vector3(66, 1.5f, 33),
new Vector3(66, 1.5f, 34),
new Vector3(67, 1.5f, 32),
new Vector3(67, 1.5f, 33),
new Vector3(67, 1.5f, 34),
new Vector3(68, 1.5f, 32),
new Vector3(68, 1.5f, 33),
new Vector3(68, 1.5f, 34),
new Vector3(19, 1.5f, 65),
new Vector3(19, 1.5f, 66),
new Vector3(19, 1.5f, 67),
new Vector3(20, 1.5f, 65),
new Vector3(20, 1.5f, 66),
new Vector3(20, 1.5f, 67),
new Vector3(21, 1.5f, 65),
new Vector3(21, 1.5f, 66),
new Vector3(21, 1.5f, 67),
new Vector3(66, 1.5f, 34),
...
new Vector3(18, 1.5f, 38),
new Vector3(18, 1.5f, 39),
new Vector3(19, 1.5f, 37),
new Vector3(19, 1.5f, 38),
new Vector3(19, 1.5f, 39),
new Vector3(20, 1.5f, 37),
...
new Vector3(45, 1, 19) };
    ...
    private void CalcularTerreno_Xmas1_Zmas1(int x, float y, int z)
    {
        ...
        else if (ComprobarTerreno0(terrenos[x, z], y, 0) == true && ComprobarTerreno2(terrenos[x + 2, z + 2], y, 180) == true && ComprobarVacio(terrenos[x + 2, z]) == true && ComprobarTerreno2(terrenos[x, z + 2], y - 0.5f, 0) == true)
        {
            PonerTerreno(rampas4rotacion90);
        }
        ...
        else if (ComprobarTerreno0(terrenos[x, z], y, 0) == true && ComprobarTerreno2(terrenos[x + 3, z + 2], y, 180) == true && ComprobarTerreno0(terrenos[x + 1, z], y, 0) == true)
        {
            PonerTerreno(esquina3rotacion270);
        }
