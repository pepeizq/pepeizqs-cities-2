...
new Vector3(88, 4, 26),
new Vector3(87, 3.5f, 30),
new Vector3(88, 3.5f, 30),
new Vector3(91, 3.5f, 23),
new Vector3(87, 3.5f, 22),
new Vector3(93, 3, 31),
new Vector3(88, 3, 32),
new Vector3(87, 3, 32),
new Vector3(82, 3, 27),
new Vector3(93, 3, 21),
new Vector3(87, 2.5f, 18),
new Vector3(88, 2, 15),
new Vector3(88, 2, 16),
new Vector3(88, 2, 17),
new Vector3(89, 2, 15),
...
new Vector3(98, 2, 25),
new Vector3(98, 2, 26),
new Vector3(75, 1.5f, 27),
new Vector3(75, 1.5f, 28),
new Vector3(75, 1.5f, 29),
new Vector3(76, 1.5f, 27),
new Vector3(76, 1.5f, 28),
new Vector3(76, 1.5f, 29),
new Vector3(77, 1.5f, 27),
new Vector3(77, 1.5f, 28),
new Vector3(77, 1.5f, 29),
new Vector3(75, 1.5f, 25),
new Vector3(75, 1.5f, 26),
new Vector3(75, 1.5f, 27),
new Vector3(76, 1.5f, 25),
new Vector3(76, 1.5f, 26),
new Vector3(76, 1.5f, 27),
new Vector3(77, 1.5f, 25),
new Vector3(77, 1.5f, 26),
new Vector3(77, 1.5f, 27),
new Vector3(73, 5, 9),
new Vector3(76, 4.5f, 12),
new Vector3(78, 4, 14),
new Vector3(79, 4, 10),
new Vector3(68, 4, 4),
new Vector3(65, 3.5f, 8),
new Vector3(66, 3.5f, 2),
new Vector3(65, 3.5f, 9),
new Vector3(66, 3.5f, 2),
new Vector3(72, 3, 19),
new Vector3(69, 2.5f, 21),
new Vector3(75, 2.5f, 21),
new Vector3(61, 2.5f, 12),
new Vector3(61, 2.5f, 8),
new Vector3(62, 2.5f, 20),
new Vector3(62, 2.5f, 20),
new Vector3(85, 2.5f, 8),
new Vector3(71, 2, 22),
new Vector3(71, 2, 23),
new Vector3(71, 2, 24),
new Vector3(72, 2, 22),
...
new Vector3(69, 2, 23),
new Vector3(69, 2, 24),
new Vector3(73, 1.5f, 24),
new Vector3(73, 1.5f, 25),
new Vector3(73, 1.5f, 26),
new Vector3(74, 1.5f, 24),
new Vector3(74, 1.5f, 25),
new Vector3(74, 1.5f, 26),
new Vector3(75, 1.5f, 24),
new Vector3(75, 1.5f, 25),
new Vector3(75, 1.5f, 26),
new Vector3(88, 1.5f, 6),
new Vector3(88, 1.5f, 7),
new Vector3(88, 1.5f, 8),
new Vector3(89, 1.5f, 6),
new Vector3(89, 1.5f, 7),
new Vector3(89, 1.5f, 8),
new Vector3(90, 1.5f, 6),
new Vector3(90, 1.5f, 7),
new Vector3(90, 1.5f, 8),
new Vector3(74, 1.5f, 24),
new Vector3(74, 1.5f, 25),
new Vector3(74, 1.5f, 26),
new Vector3(75, 1.5f, 24),
new Vector3(75, 1.5f, 25),
new Vector3(75, 1.5f, 26),
new Vector3(76, 1.5f, 24),
new Vector3(76, 1.5f, 25),
new Vector3(76, 1.5f, 26),
new Vector3(57, 1.5f, 23),
new Vector3(57, 1.5f, 24),
new Vector3(57, 1.5f, 25),
new Vector3(58, 1.5f, 23),
new Vector3(58, 1.5f, 24),
new Vector3(58, 1.5f, 25),
new Vector3(59, 1.5f, 23),
new Vector3(59, 1.5f, 24),
new Vector3(59, 1.5f, 25),
new Vector3(72, 1.5f, 24),
new Vector3(72, 1.5f, 25),
new Vector3(72, 1.5f, 26),
new Vector3(73, 1.5f, 24),
new Vector3(73, 1.5f, 25),
new Vector3(73, 1.5f, 26),
new Vector3(74, 1.5f, 24),
new Vector3(74, 1.5f, 25),
new Vector3(74, 1.5f, 26),
new Vector3(56, 1.5f, 13),
new Vector3(56, 1.5f, 14),
new Vector3(56, 1.5f, 15),
new Vector3(57, 1.5f, 13),
new Vector3(57, 1.5f, 14),
new Vector3(57, 1.5f, 15),
new Vector3(58, 1.5f, 13),
new Vector3(58, 1.5f, 14),
new Vector3(58, 1.5f, 15),
new Vector3(88, 1.5f, 10),
new Vector3(88, 1.5f, 11),
new Vector3(88, 1.5f, 12),
new Vector3(89, 1.5f, 10),
new Vector3(89, 1.5f, 11),
new Vector3(89, 1.5f, 12),
new Vector3(90, 1.5f, 10),
new Vector3(90, 1.5f, 11),
new Vector3(90, 1.5f, 12),
new Vector3(56, 1.5f, 8),
new Vector3(56, 1.5f, 9),
new Vector3(56, 1.5f, 10),
new Vector3(57, 1.5f, 8),
new Vector3(57, 1.5f, 9),
new Vector3(57, 1.5f, 10),
new Vector3(58, 1.5f, 8),
new Vector3(58, 1.5f, 9),
new Vector3(58, 1.5f, 10),
new Vector3(72, 1, 25),
new Vector3(72, 1, 26),
new Vector3(72, 1, 27),
new Vector3(72, 1, 28),
